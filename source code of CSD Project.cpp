...
void sum(t1 a,t2 b)                                                     // defining template function
{
    float add;
    add=a+b;
    cout << HSPACE << "\t\t\t" <<"                                              GRAND TOTAL = INR. " << add << endl;
}
...
void Admin::controlAdmin1(void)                                       //extra options for product menu
{
                                    ...
                                    switch(option3)
                                    {
                                        case 1:
                                        {
                                            ...
                                            char c;
                                            int n;
                                            cout << HSPACE << "Enter Last Two Digits of The Product Id To be Modified:  ";
                                            cin >> object;
                                            cin.get(ch);
     ...
     int option3;
                                    ...
                                    switch(option3)
                                    {
                                        case 1:
                                        {
                                            ...
                                            int object;
                                            char ch;
                                            cout << HSPACE << "Enter Last Two Digits of The Customer Id To be Modified:  ";
                                            cin >> object;
                                            cin.get(ch);
...
{    
     showprod(7);     
                    Login l;                                                
                                            ...
                                            inoutfile.open("ABC.txt",ios::ate | ios::in | ios::out | ios::binary);
                                            int object;
                                            cout << HSPACE << "Enter Last Two Digits of The Product Id To be bought:  ";
                                            cin >> object;
                                            int location=(object-1) * sizeof (F1);
                                            if(inoutfile.eof())
                                            {
...
void Login::password(void)                                            //ENTERING LOGIN ID AND PASSWORD
   {
        cout << HSPACE << "Login_Id:";
        cin >> Login_Id;
        if(Login_Id == "csdchd" || Login_Id == "CSDCHD")
        {
            cout << HSPACE <<"Password:";
            cin >> Password;
        try                                                                                                     //exception handling
        {
            if (Password == "Cantt@34161")
            {
                cout << endl;
            ...
            {
               cout << HSPACE <<"    Access Denied  " << endl;
               throw(Password);
        ...
        {
            cout << HSPACE << "Password is Incorrect" << endl;
            cout << HSPACE << "Your entered Password is : " << Password <<endl;
            cout << endl;
            password();
        }
     }
     ...
     {
         cout << HSPACE << "Login ID is Incorrect" << endl;
         password();
     } 
    }
